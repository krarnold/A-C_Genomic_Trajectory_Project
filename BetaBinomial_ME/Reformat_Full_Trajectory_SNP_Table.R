...
#read in data
data <- read.csv("SNP_Table/arnold25_genomic_trajectory_SNP_table_counts.csv", header = T)
...
write.csv(final_table, file = "AC_trajectory_modified_snp_table.csv", row.names = FALSE)
